<%-- 
    Document   : apple
    Created on : 3 Mar, 2013, 11:31:24 PM
    Author     : sony
--%>
...
<html>
    <head>
        ...
        <body>
            <form method="post" action="TDetails.jsp" name="apple">
            ...
            <center>
                <br><br>
                <img src="../images/apple.jpg" height="100" width="100"/><br><br>                
                <img src="../images/AppleIpad.jpg" height="300" width="600">&nbsp;&nbsp;
                <img src="../images/AppleIpadMini.jpg" height="300" width="600"><br><br>     
                <img src="../images/ipadspec.jpg">&nbsp;&nbsp;
                <img src="../images/ipadminispec.jpg"><br><br>
                <hr><br><br>
                <table>
                    <tr>
                        <td>Model </td>
