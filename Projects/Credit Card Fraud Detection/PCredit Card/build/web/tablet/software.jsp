<%-- 
    Document   : software
    Created on : 4 Mar, 2013, 12:18:12 AM
    Author     : sony
--%>
    ...
    <head>
        ...
        <body>
            ...
            <center>            
               ...
               <h1>Apple</h1></br>
                <p>Currently 6.01 Version is available.</p>
                <p>Version 7 will be available soon.</p>
                </br></br>
                <h1>Microsoft</h1></br>
                <p>Currently Windows 8 service pack 1 is available.</p>
                </br></br>
                <h1>Sony</h1></br>
                <p>Currently Icecream Sandwich is available. </p>
                <p>Jelly Bean is only available for some devices</p>            
            </center>
        </form>
    </body>
</html>
