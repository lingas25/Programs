<%-- 
    Document   : microsoft
    Created on : 3 Mar, 2013, 11:42:56 PM
    Author     : sony
--%>
...
<html>
    <head>
        ...
        <body>
            <form method="post" action="TDetails.jsp" name="microsoft">
            ...
            <center>
                <img src="../images/microsoft.jpg" height="200" width="300"/>
                </br></br>                
                <img src="../images/Surface.jpg" height="300" width="600">&nbsp;&nbsp;
                <img src="../images/SurfacePro.jpg" height="300" width="600"></br></br>     
                <img src="../images/surfacespec.jpg">&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="../images/surfaceprospec.jpg"></br></br>
                <hr></br></br>
                <table>
                    <tr>
                        <td>Model </td>
                        <td><select onchange="print_storage('storage', this.selectedIndex);
                                prices();" id="model" name ="model"></select></td>
                    </tr>
                    <tr>
                        <td>Storage</td>
                ...
                <input type="hidden" name="product" value= "Microsoft">
        </form>
    </body>
</html>
